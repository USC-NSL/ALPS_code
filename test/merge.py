...
def call_merge(impath): # merge the six images into one
	...
	if pos in pos_list: # never seen this location before
		...
		cmd = './code_with_zoom/merge/merge_support ' + impath + ' ' + \
...
if __name__ == '__main__':
	...
	# input_dir = './data/subway/photo/'
	input_dir = work_dir + 'image_with_zoom/'
	print input_dir
	# RES_DIR = sys.argv[2]
	# RES_DIR = './data/subway/photo_res/'
	RES_DIR = work_dir + 'image_merged/'
	print RES_DIR
